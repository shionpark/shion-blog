...
highlights:
  - id: C-11
    before: "커밋이 쌓였고, 이걸 역할별"
    after: "커밋이 쌓였고 이걸 역할별"
  - id: C-11
    before: "rebase가 실행되고, 해당 커밋이"
    after: "rebase가 실행되고 해당 커밋이"
residual_findings: (없음)
grade_reason: "A — S1 잔존 0건, S2 잔존 0건, 변경률 0.1%, 자체검증 6항 통과. 원문이 이미 자연스러운 기술 블로그 문체로 AI 패턴이 거의 없음."
-->
