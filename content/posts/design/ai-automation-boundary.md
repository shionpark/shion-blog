...
highlights:
  - id: C-11
    before: "조사하고, 경쟁사 콘텐츠를 분석하고, 글을 작성하는"
    after: "조사하고 경쟁사 콘텐츠를 분석하고 글을 작성하는"
  - id: I-1
    before: ""검토가 필요한 것만 검토하는 상태"를 만든 것이다."
    after: ""검토가 필요한 것만 검토하는 상태"를 만들었다."
  - id: I-1
    before: "8점이라는 임계값은 경험적으로 정한 것이다."
    after: "8점이라는 임계값은 경험적으로 정했다."
  - id: C-11
    before: "하드코딩하지 않고, 외부 AI 서비스에서"
    after: "하드코딩하지 않고 외부 AI 서비스에서"
  - id: desc
    before: "어디까지 자동화하고 어디서 사람이 개입할지 결정한 과정을 정리한다."
    after: "자동화 범위와 사람 개입 지점을 정한 과정."
residual_findings: (없음)
grade_reason: "A — S1 0건, 변경률 1.8%, 자체검증 6항 통과. 원문 자체가 깨끗한 블로그 글이라 최소 교정만 적용."
-->
